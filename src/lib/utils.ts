...
export function getStatusColor(status: string): string {
    const map: Record<string, string> = {
        ...
        Enquiry: 'bg-sky-500/20 text-sky-300 border-sky-500/30',
        ...
        Overbilling: 'bg-red-500/20 text-red-400 border-red-500/30',
        overbilling: 'bg-red-500/20 text-red-400 border-red-500/30',
        Underbilling: 'bg-amber-500/20 text-amber-400 border-amber-500/30',
        underbilling: 'bg-amber-500/20 text-amber-400 border-amber-500/30',
        ...
        hourly: 'bg-cyan-500/20 text-cyan-300 border-cyan-500/30',
        per_litre: 'bg-purple-500/20 text-purple-300 border-purple-500/30',
        per_unit: 'bg-purple-500/20 text-purple-300 border-purple-500/30',
